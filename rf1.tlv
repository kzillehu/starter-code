...
\TLV
   ...
   // (3) Decoder - Control Unit Logic
   // opcode is in last 7 bits in instruction
   // last 2 are always 11 so they are ignored in the comparisons below, only use instr[6:2]
   ...
   //extract immedaites and other fields embedded within the instruction
   ...
   // extract the rest of the fields from the instructions. 
   ...
   // decode bits for specific instructions
   ...
   // (6) RF Write - Write RF Logic
   
   // (7) DMem Logic - Read or Write to DMem
